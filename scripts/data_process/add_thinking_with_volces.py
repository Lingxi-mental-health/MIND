...
def main():
    """主函数"""
    # 文件路径
    input_file = os.path.join(DATA_ROOT, "generated_conversation_data_2000.json")
    output_file = os.path.join(DATA_ROOT, "generated_conversation_data_2000_with_thinking.json")
    parquet_file = os.path.join(DATA_ROOT, "generated_conversation_data_2000_with_thinking.parquet")
